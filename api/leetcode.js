...
export class Leetcode {
    ...
    _postDailyIntoChannel = async ({frontendQuestionId, title, link , difficulty, acRate}) => {
    ...
    _postWeeklyIntoChannel = async ({questionFrontendId, title, link , remainingTimeMessage}) => {
